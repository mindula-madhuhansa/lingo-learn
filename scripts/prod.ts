...
const main = async () => {
  try {
    ...
    const courses = await db
      ...
      .values([{ title: "Korean", imageSrc: "/assets/flags/kr.svg" }])
      .returning();
            ...
            if (challenge.order === 1) {
              await db.insert(schema.challengeOptions).values([
                ...
                },
                {
                  ...
                  audioSrc: "/assets/audios/kr_boy.mp3",
                },
              ]);
            }
            ...
            if (challenge.order === 5) {
              await db.insert(schema.challengeOptions).values([
                ...
                },
                {
                  ...
                  correct: true,
                  text: "좀비",
                  imageSrc: "/assets/images/zombie.svg",
                  audioSrc: "/assets/audios/kr_zombie.mp3",
                },
              ]);
            }
              ...
              await db.insert(schema.challengeOptions).values([
                {
                  ...
                  correct: true,
                  text: "여자아이",
                  imageSrc: "/assets/images/girl.svg",
                  audioSrc: "/assets/audios/kr_girl.mp3",
                },
                {
                  challengeId: challenge.id,
                  correct: false,
